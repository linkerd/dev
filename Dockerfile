...
ARG JUST_VERSION=1.51.0 # repo=casey/just
...
FROM apt-base as yq
ARG YQ_VERSION=v4.53.2 # repo=mikefarah/yq
...
ARG HELM_VERSION=v4.1.4 # repo=helm/helm
...
ARG KUBECTL_VERSION=v1.36.1 # repo=kubernetes/kubernetes
...
ARG PROTOC_VERSION=v34.1 # repo=protocolbuffers/protobuf
...
ARG CARGO_AUDITABLE_VERSION=v0.7.4 # repo=rust-secure-code/cargo-auditable
...
ARG CARGO_DENY_VERSION=0.19.6 # repo=EmbarkStudios/cargo-deny
...
ARG NEXTEST_VERSION=0.9.133 # repo=nextest-rs/nextest,prefix=cargo-nextest-
...
ARG CARGO_TARPAULIN_VERSION=0.35.4 # repo=xd009642/tarpaulin
